...
public class SwordAnimation : MonoBehaviour
{
    ...
    private void HandleInputs()
    {
        ...
        mouseX = PlayerInputBase.Instance.inputMousePos.x;
        mouseY = PlayerInputBase.Instance.inputMousePos.y;
        ...
        verticalMovement = PlayerInputBase.Instance.inputVector.y;
        horizontalMovement = PlayerInputBase.Instance.inputVector.x;
    ...
    private void HandleHeavyAttack()
    {
        ...
        if (PlayerInputBase.Instance.inputMR)
        {
    ...
    {
        if (PlayerInputBase.Instance.input1)
        {
    ...
    {
        if (PlayerInputBase.Instance.inputE)
        {
            isStrafing = true;
        }
        else
    ...
    private void HandleSprint()
    {
        ...
        if (PlayerInputBase.Instance.inputShift && moveAmount > 0)
        {
            isSprinting = true;
            isWalking = false;
            isRunning = true;
    ...
    private void HandleWalkOrRun()
    {
        ...
        if (PlayerInputBase.Instance.inputV)
        {
