...
public class GUIGameSetting : GUIPopUp
{
    ...
    public override void Open()
    {
        ...
        _enemyCnt = GameManager.Instance.Setting.EnemyCnt;
        _phaseCnt = GameManager.Instance.Setting.PhaseCnt;
        _enemyList = new List<string>(GameManager.Instance.Setting.Enemy);
        _bossEnemyList = new List<string>(GameManager.Instance.Setting.BossEnemy);
    ...
    public void Apply() {
        ...
        GameManager.Instance.Setting.Enemy = _enemyList;
        GameManager.Instance.Setting.BossEnemy = _bossEnemyList;

        GameManager.Instance.Setting.PhaseCnt = _phaseCnt;
        GameManager.Instance.Setting.EnemyCnt = _enemyCnt;

        GameManager.Instance.Setting.MapName = _mapName;
